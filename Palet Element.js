     ...
     this.body = document.createElement("div")
      ...
      that.colors[0].style.marginTop = 12 * size + "px"
       function createSwch(i) {
        ...
        createCSSline("#palet_lineWidth", ["margin-top: " + 12 * size + "px", "border-radius: " + 8 * size/2 + "px"])
        ...
        this.controls = document.createElement("div")
         ...
         createCSSline(".palet_conts", ["width: " + 120 * size + "px",
                                        ...
                                        "margin-left: " + 24 * size + "px"])
         conts.clickReaction(function(e, research) {
           var x = research.x
           if(x < conts.offsetWidth/4) { tools.controlBrush(-1) }
           else if(x < conts.offsetWidth*3/4) { bookmark_one.closeBook() }
