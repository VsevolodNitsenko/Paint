 ...
 document.getElementById("start").addResizeMap(function(e) {
  ...
  document.getElementById("table").addResizeMap(function(e) {
   ...
   document.addEventListener("touchstart", function(e) { console.log(e); executor.down(e) })
   document.addEventListener("touchmove", function(e) { console.log(e); executor.move(e) })
   document.addEventListener("touchend", function(e) { console.log(e); executor.up(e) })
