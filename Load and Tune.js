 ...
 document.getElementById("start").addResizeMap(function(e) {
  ...
  document.getElementById("table").addResizeMap(function(e) {
   ...
   document.addEventListener("touchstart", function(e) { executor.down(e) })
   document.addEventListener("touchmove", function(e) { executor.move(e) }
   document.addEventListener("touchend", function(e) { executor.up(e) }
