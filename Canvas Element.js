class Canvas {
  ...
  createCSSline(".CanvasY", ["border: 1px solid rgba(0,0,0,0)",
   ...
   this.ndDraw = function(e) {
    ...
    this.resizeElement = function(width, height, DisableCorrection) {
      var isNum = (typeof width == "number" && typeof height == "number")
      var isNaN = (width.toString() != "NaN" && height.toString() != "NaN")
      if(isNum && isNaN) {
        createCanvas(width, height)
         } else {
        console.log("sizes must be numbers .. ? ", width, height)
        createCanvas(that.defaultWidth, that.defaultHeight)
       }
